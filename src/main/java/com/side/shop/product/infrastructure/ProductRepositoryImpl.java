    ...
    public Page<Product> searchProducts(ProductSearchCond condition, Pageable pageable) {
        List<Product> content = jpaQueryFactory
                ...
                .where(
                        ...
                        productOption.size.eq(condition.getSize()),
                        productOption.color.eq(condition.getColor()),
                        productOption.price.between(condition.getMinPrice(), condition.getMaxPrice()))
